...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__libs_vue_js__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__libs_buefy_min_js__ = __webpack_require__(4);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__libs_lodash_min_js__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_paginator_js__ = __webpack_require__(3);
...
new __WEBPACK_IMPORTED_MODULE_0__libs_vue_js___default.a({
  ...
  components: {
    VPaginator: __WEBPACK_IMPORTED_MODULE_3__components_paginator_js__["default"]
  },
  watch: {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__libs_vue_resource_min_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__libs_vue_resource_min_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__libs_vue_resource_min_js__);
...
!function (t, e) {
  ...
  function t(t) {
    ...
    var n, o;if (Q(t)) for (n = 0; n < t.length; n++) e.call(t[n], t[n], n);else if (p(t)) for (o in t) G.call(t, o) && e.call(t[o], t[o], o);return t;
  }function b(t) {
    ...
    var e = ["+", "#", ".", "/", ";", "?", "&"],
        n = [];return { vars: n, expand: function (o) {
    ...
    var n = this || {},
        r = lt(n.$vm);return g(t || {}, n.$options, B.options), B.interceptors.forEach(function (t) {
    ...
    var r = this || {},
        i = {};return n = Y({}, M.actions, n), v(n, function (n, u) {
    ...
    var n,
        ...
        break;default:
        throw "Expected up to 2 arguments [params, body], got " + e.length + " arguments";}return o.body = n, o.params = Y({}, o.params, r), o;
  }function D(t) {
    D.installed || (K(t), t.url = U, t.http = B, t.resource = M, t.Promise = e, Object.defineProperties(t.prototype, { $url: { get: function () {
    ...
    return new t(function (n, o) {
      var r = 0,
          i = [];0 === e.length && n(i);for (var u = 0; u < e.length; u += 1) t.resolve(e[u]).then(function (t) {
        return function (o) {
    ...
    var e = this;if (e.state === J) {
      if (t === e) throw new TypeError("Promise settled with itself.");var n = !1;try {
        var o = t && t.then;if (null !== t && "object" == typeof t && "function" == typeof o) return void o.call(t, function (t) {
          n || e.resolve(t), n = !0;
        }, function (t) {
          n || e.reject(t), n = !0;
        });
  ...
  }, Object.defineProperty(yt.prototype, "data", { get: function () {
      return this.body;
    }, set: function (t) {
      this.body = t;
    } });var vt = function (t) {
    ...
    return new yt(t, Y(e || {}, { url: this.getUrl() }));
      ...
      gt = { "Content-Type": "application/json;charset=utf-8" };return B.options = {}, B.headers = { put: gt, post: gt, patch: gt, delete: gt, common: bt, custom: {} }, B.interceptor = { before: ct, method: ft, jsonp: at, json: ut, form: it, header: pt, cors: rt }, B.interceptors = ["before", "method", "jsonp", "json", "form", "header", "cors"], ["get", "delete", "head", "jsonp"].forEach(function (t) {
    B[t] = function (e, n) {
